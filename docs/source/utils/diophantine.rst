...
:math:`\xi = t \cdot t^\dagger` for :math:`t \in \mathbb{D}\left[ \omega \right]` where :math:`\xi \in \mathbb{D} \left[ \sqrt{2} \right]` is given.

Diophantine Equation Module
---------------------------
.. automodule:: qdecomp.utils.diophantine.diophantine_equation
    :members:
    :undoc-members:
    :show-inheritance:
