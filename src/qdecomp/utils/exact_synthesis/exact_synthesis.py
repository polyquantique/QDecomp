...
The algorithm is based on the paper by Kliuchnikov, Maslov Mosca [1]_.
...
.. [1] Vadym Kliuchnikov, Dmitri Maslov and Michele Mosca, Fast and efficient exact synthesis of single qubit unitaries generated by Clifford and T gates, 2013, https://arxiv.org/abs/1206.5236.
"""
...
""" Domega: First element of H gate (1/sqrt(2)) """
...
""" Domega: Domega representation of omega (sqrt(2)/2 + i*sqrt(2)/2) """

T_22_INV: Domega = Domega((-1, 0), (0, 0), (0, 0), (0, 0))
""" Domega: Last element of Tdag gate (-omega) """
...
""" np.ndarray[Domega]: Domega representation of Tdag gate """
...
def exact_synthesis_reduc(U: np.ndarray) -> tuple[str, np.ndarray]:
    ...
    This part of the algorithm is based on Algorithm 1 from the paper by Vadym Kliuchnikov, Dmitri Maslov,
    and Michele Mosca [1]_.
...
def is_unitary_deomega(matrix: np.ndarray) -> bool:
