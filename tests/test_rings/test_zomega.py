...
@pytest.mark.parametrize("n", [Zomega(1, 1, 1, 1), Zomega(0, 0, 0, 0), Zomega(-1, 1, 1, -1), Zomega(1, 2, -5, 4), Zomega(-55, 14, 77, 23), Zomega(36, 71, 41, -94)])
def test_real(n):
...
@pytest.mark.parametrize("n1", [Zomega(1, 1, 1, 1), Zomega(0, 0, 0, 0), Zomega(-1, 1, 1, -1), Zomega(1, 2, -5, 4), Zomega(-55, 14, 77, 23), Zomega(36, 71, 41, -94), 0, 5, -10, 100])
@pytest.mark.parametrize("n2", [Zomega(1, 1, 1, 1), Zomega(0, 0, 0, 0), Zomega(-1, 1, 1, -1), Zomega(1, 2, -5, 4), Zomega(-55, 14, 77, 23), Zomega(36, 71, 41, -94)])
...
@pytest.mark.parametrize("base", [Zomega(1, 1, 1, 1), Zomega(0, 0, 0, 0), Zomega(-1, 1, 1, -1), Zomega(1, 2, -5, 4), Zomega(-55, 14, 77, 23), Zomega(36, 71, 41, -94)])
...
def test_sqrt2_conjugate():
    ...
    n = Zomega(1, -2, -4, 5)
    assert n.sqrt2_conjugate() == Zomega(-1, -2, 4, 5) and n.sqrt2_conjugate().sqrt2_conjugate() == n 

def test_zsqrt2_complex_conjugate():
    """Test the complex_conjugate method of the class Zomega."""
    n = Zomega(1, -2, -4, 5)
    assert n.complex_conjugate() == Zomega(4, 2, -1, 5) and np.isclose((n * n.complex_conjugate()).imag(), 0)
...
def test_equality():
    ...
    assert Zomega(0, -1, 0, 1) == 1 - 1.j
    assert Zomega(1, 1, 1, 1) != [1]

@pytest.mark.parametrize("n", [(Zomega(1, 1, 1, 1), '1ω3 + 1ω2 + 1ω1 + 1'),
...
@pytest.mark.parametrize("n", [(-25, Zomega(0, 0, 0, -25)),
                               (12-5.j, Zomega(0, -5, 0, 12)),
