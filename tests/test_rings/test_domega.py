...
OMEGA = (1 + 1.j)/math.sqrt(2)

SQRT2_DOMEGA = Domega.from_ring(r.Zsqrt2(0, 1))
INV_DOMEGA = Domega((-1, 1), (0, 0), (1, 1), (0, 0))

@pytest.mark.parametrize("n", [Domega((0, 0), (0, 0), (0, 0), (0, 0)), Domega((1, 1), (1, 1), (1, 1), (1, 1)), Domega((-1, 1), (-1, 1), (1, 1), (1, 1)), Domega((1, 2), (-5, 4), (1, 2), (-27, 4)), Domega((-55, 14), (77, 23), (36, 71), (-41, 94)), Domega((131, 211), (23, 43), (-73, 43), (41, 94))])
def test_real(n):
...
@pytest.mark.parametrize("n1", [Domega((0, 0), (0, 0), (0, 0), (0, 0)), Domega((1, 1), (1, 1), (1, 1), (1, 1)), Domega((-1, 1), (-1, 1), (1, 1), (1, 1)), Domega((1, 2), (-5, 4), (1, 2), (-27, 4)), Domega((-55, 14), (77, 23), (36, 71), (-41, 94)), Domega((131, 211), (23, 43), (-73, 43), (41, 94)), 0, 5, -10, 100])
@pytest.mark.parametrize("n2", [Domega((1, 1), (1, 1), (1, 1), (1, 1)), Domega((0, 0), (0, 0), (0, 0), (0, 0)), Domega((-1, 1), (-1, 1), (1, 1), (1, 1)), Domega((1, 2), (-5, 4), (1, 2), (-27, 4)), Domega((-55, 14), (77, 23), (36, 71), (-41, 94)), Domega((131, 211), (23, 43), (-73, 43), (41, 94)), r.D(1, 1), r.D(-67, 23)])
def test_addition(n1, n2):
    """Test the addition of two Domega numbers."""
    n = n1
    n += n2
    assert np.isclose(complex(n1 + n2), complex(n1) + complex(n2)) and np.isclose(complex(n), complex(n1) + complex(n2))
...
@pytest.mark.parametrize("base", [Domega((0, 0), (0, 0), (0, 0), (0, 0)), Domega((1, 1), (1, 1), (1, 1), (1, 1)), Domega((-1, 1), (-1, 1), (1, 1), (1, 1)), Domega((1, 2), (-5, 4), (1, 2), (-27, 4)), Domega((-55, 14), (77, 23), (36, 71), (-41, 94)), Domega((131, 211), (23, 43), (-73, 43), (41, 94))])
@pytest.mark.parametrize("exp", [0, 1, 3, 6, 10])
def test_power(base, exp):
    """Test the power of a Domega number."""
    n = base
    n **= exp
    assert np.isclose(complex(base ** exp), complex(base) ** exp) and np.isclose(complex(n), complex(base) ** exp)
...
@pytest.mark.parametrize("n", [Domega((1, 1), (1, 1), (1, 1), (1, 1)), 
...
@pytest.mark.parametrize("n", [(Domega((1, 1), (1, 1), (1, 1), (1, 1)), '1/2^1ω3 + 1/2^1ω2 + 1/2^1ω + 1/2^1'),
...
@pytest.mark.parametrize("n", [(-25, Domega((0, 0), (0, 0), (0, 0), (-25, 0))),
                               (12-5.j, Domega((0, 0), (-5, 0), (0, 0), (12, 0))),
